...
/**
 * The class is an exception and being used by the prolog parser to notify user about a syntax prolog problem and its position in the source.
 * 
...
public class PrologParserException extends Exception {
	...
	/**
	 * The variable contains the line number of the problem. The first line has the index 1.
	 */
	protected final int lineNumber;
	
	/**
	 * The variable contains the string position of the problem. The first char has the index 1.
	 */
	...
	/**
	 * Allows to check that the exception contains valid line-string position information, they must be more than zero.
	 * @return true if both the line index and the string position are more than zero, else false
	 */
