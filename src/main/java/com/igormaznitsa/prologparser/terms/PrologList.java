...
public final class PrologList extends PrologStructure {
	...
	/**
	 * A Constructor. It allows to create a prolog list chain from an array contains prolog term objects.
	...
	/**
	 * A Constructor. It allows to create a list and set the argument as the list head element.
	 ...
	 * @return the head of the list, if it is a null list then it will return null.
	 */
	 ...
	 * @return the tail of the list, if it is a null list then it will return null
	 */
	...
	/**
	 * Set new list tail to a list and return the created list (or the same list if the list is an empty list).
	 ...
	 * @return if the list is an empty one then the list will be returned else new list will be created and returned
	 */
	...
	/**
	 * Add a term as new list into the end of the list chain where the current list is being presented. If the last list in the chain contains the tail which is not a list then its tail will be just replaced else new list will be created and set as the tail for the last list. 
	 * @param term a term to be added, must not be null.
	 * @return new list or the last list in the chain.
	 */
	public final PrologList addAsNewListToEndOfListChain(final AbstractPrologTerm term) {
		if (term == null)
			throw new NullPointerException("Term is null");
	 ...
	 * @param elementToReplace a prolog term to replace the tail of the last list in the chain, must not be null
	 */
	public final void replaceLastElement(final AbstractPrologTerm elementToReplace) {
