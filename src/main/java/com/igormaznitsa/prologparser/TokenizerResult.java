...
/**
 * The class is a container to save information about parsed token, tokenizer state during that operation and the parsed term.
 * 
...
public final class TokenizerResult {
	 ...
	 * @param parserState the tokenizer state to be saved in the object, must not be null.
	 */
