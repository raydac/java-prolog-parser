...
test_number_codes :-
	test_val(number_codes(33, L), L, [charcode('3'), charcode('3')]),
        test_val(number_codes(A, [charcode('-'), charcode('2'),charcode('5')]), A, -25),
        test_true(number_codes(3.14159, Pi)),
        test_true(number_codes(15, [charcode('0'), charcode('x'), charcode('f')])).
